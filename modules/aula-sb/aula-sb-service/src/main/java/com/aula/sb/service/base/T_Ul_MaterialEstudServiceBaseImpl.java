...
import com.aula.sb.service.T_Ul_MaterialEstudService;
...
/**
 * Provides the base implementation for the t_ ul_ material estud remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.aula.sb.service.impl.T_Ul_MaterialEstudServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.aula.sb.service.impl.T_Ul_MaterialEstudServiceImpl
 * @generated
 */
public abstract class T_Ul_MaterialEstudServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, T_Ul_MaterialEstudService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>T_Ul_MaterialEstudService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>T_Ul_MaterialEstudServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			T_Ul_MaterialEstudService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		t_Ul_MaterialEstudService = (T_Ul_MaterialEstudService)aopProxy;

		_setServiceUtilService(t_Ul_MaterialEstudService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return T_Ul_MaterialEstudService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = T_Ul_MaterialEstudServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, t_Ul_MaterialEstudService);
		}
	...
	@Reference
	protected com.aula.sb.service.T_Ul_MaterialEstudLocalService
		t_Ul_MaterialEstudLocalService;

	protected T_Ul_MaterialEstudService t_Ul_MaterialEstudService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		T_Ul_MaterialEstudServiceBaseImpl.class);
