...
import com.aula.sb.service.T_Ul_AdministradorService;
import com.aula.sb.service.T_Ul_AdministradorServiceUtil;
...
/**
 * Provides the base implementation for the t_ ul_ administrador remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.aula.sb.service.impl.T_Ul_AdministradorServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.aula.sb.service.impl.T_Ul_AdministradorServiceImpl
 * @generated
 */
public abstract class T_Ul_AdministradorServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, T_Ul_AdministradorService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>T_Ul_AdministradorService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>T_Ul_AdministradorServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			T_Ul_AdministradorService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		t_Ul_AdministradorService = (T_Ul_AdministradorService)aopProxy;

		_setServiceUtilService(t_Ul_AdministradorService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return T_Ul_AdministradorService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = T_Ul_AdministradorServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, t_Ul_AdministradorService);
		}
	...
	@Reference
	protected com.aula.sb.service.T_Ul_AdministradorLocalService
		t_Ul_AdministradorLocalService;

	protected T_Ul_AdministradorService t_Ul_AdministradorService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		T_Ul_AdministradorServiceBaseImpl.class);
