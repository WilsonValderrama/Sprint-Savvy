...
import com.aula.sb.service.T_Ul_ResEvaluacionService;
...
/**
 * Provides the base implementation for the t_ ul_ res evaluacion remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.aula.sb.service.impl.T_Ul_ResEvaluacionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.aula.sb.service.impl.T_Ul_ResEvaluacionServiceImpl
 * @generated
 */
public abstract class T_Ul_ResEvaluacionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, T_Ul_ResEvaluacionService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>T_Ul_ResEvaluacionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>T_Ul_ResEvaluacionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			T_Ul_ResEvaluacionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		t_Ul_ResEvaluacionService = (T_Ul_ResEvaluacionService)aopProxy;

		_setServiceUtilService(t_Ul_ResEvaluacionService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return T_Ul_ResEvaluacionService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = T_Ul_ResEvaluacionServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, t_Ul_ResEvaluacionService);
		}
	...
	@Reference
	protected com.aula.sb.service.T_Ul_ResEvaluacionLocalService
		t_Ul_ResEvaluacionLocalService;

	protected T_Ul_ResEvaluacionService t_Ul_ResEvaluacionService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		T_Ul_ResEvaluacionServiceBaseImpl.class);
