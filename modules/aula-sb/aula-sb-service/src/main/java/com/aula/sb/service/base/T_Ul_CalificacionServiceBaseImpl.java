...
import com.aula.sb.service.T_Ul_CalificacionService;
...
/**
 * Provides the base implementation for the t_ ul_ calificacion remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.aula.sb.service.impl.T_Ul_CalificacionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.aula.sb.service.impl.T_Ul_CalificacionServiceImpl
 * @generated
 */
public abstract class T_Ul_CalificacionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, T_Ul_CalificacionService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>T_Ul_CalificacionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>T_Ul_CalificacionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			T_Ul_CalificacionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		t_Ul_CalificacionService = (T_Ul_CalificacionService)aopProxy;

		_setServiceUtilService(t_Ul_CalificacionService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return T_Ul_CalificacionService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = T_Ul_CalificacionServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, t_Ul_CalificacionService);
		}
	...
	@Reference
	protected com.aula.sb.service.T_Ul_CalificacionLocalService
		t_Ul_CalificacionLocalService;

	protected T_Ul_CalificacionService t_Ul_CalificacionService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		T_Ul_CalificacionServiceBaseImpl.class);
