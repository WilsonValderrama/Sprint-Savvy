...
import com.aula.sb.service.T_Ul_EstudianteService;
import com.aula.sb.service.T_Ul_EstudianteServiceUtil;
...
/**
 * Provides the base implementation for the t_ ul_ estudiante remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.aula.sb.service.impl.T_Ul_EstudianteServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.aula.sb.service.impl.T_Ul_EstudianteServiceImpl
 * @generated
 */
public abstract class T_Ul_EstudianteServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, T_Ul_EstudianteService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>T_Ul_EstudianteService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>T_Ul_EstudianteServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			T_Ul_EstudianteService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		t_Ul_EstudianteService = (T_Ul_EstudianteService)aopProxy;

		_setServiceUtilService(t_Ul_EstudianteService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return T_Ul_EstudianteService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = T_Ul_EstudianteServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, t_Ul_EstudianteService);
		}
	...
	@Reference
	protected com.aula.sb.service.T_Ul_EstudianteLocalService
		t_Ul_EstudianteLocalService;

	protected T_Ul_EstudianteService t_Ul_EstudianteService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		T_Ul_EstudianteServiceBaseImpl.class);
