...
import com.aula.sb.service.T_Ul_CursoService;
...
/**
 * Provides the base implementation for the t_ ul_ curso remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.aula.sb.service.impl.T_Ul_CursoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.aula.sb.service.impl.T_Ul_CursoServiceImpl
 * @generated
 */
public abstract class T_Ul_CursoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, T_Ul_CursoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>T_Ul_CursoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>T_Ul_CursoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			T_Ul_CursoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		t_Ul_CursoService = (T_Ul_CursoService)aopProxy;

		_setServiceUtilService(t_Ul_CursoService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return T_Ul_CursoService.class.getName();
	}
	...
	private void _setServiceUtilService(T_Ul_CursoService t_Ul_CursoService) {
		try {
			Field field = T_Ul_CursoServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, t_Ul_CursoService);
		}
	...
	@Reference
	protected com.aula.sb.service.T_Ul_CursoLocalService t_Ul_CursoLocalService;

	protected T_Ul_CursoService t_Ul_CursoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		T_Ul_CursoServiceBaseImpl.class);
