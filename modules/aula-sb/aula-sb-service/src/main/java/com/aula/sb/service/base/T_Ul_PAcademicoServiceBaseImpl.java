...
import com.aula.sb.service.T_Ul_PAcademicoService;
...
/**
 * Provides the base implementation for the t_ ul_p academico remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.aula.sb.service.impl.T_Ul_PAcademicoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.aula.sb.service.impl.T_Ul_PAcademicoServiceImpl
 * @generated
 */
public abstract class T_Ul_PAcademicoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, T_Ul_PAcademicoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>T_Ul_PAcademicoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>T_Ul_PAcademicoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			T_Ul_PAcademicoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		t_Ul_PAcademicoService = (T_Ul_PAcademicoService)aopProxy;

		_setServiceUtilService(t_Ul_PAcademicoService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return T_Ul_PAcademicoService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = T_Ul_PAcademicoServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, t_Ul_PAcademicoService);
		}
	...
	@Reference
	protected com.aula.sb.service.T_Ul_PAcademicoLocalService
		t_Ul_PAcademicoLocalService;

	protected T_Ul_PAcademicoService t_Ul_PAcademicoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		T_Ul_PAcademicoServiceBaseImpl.class);
