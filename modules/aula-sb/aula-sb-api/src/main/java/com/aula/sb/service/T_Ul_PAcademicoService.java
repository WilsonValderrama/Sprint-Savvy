...
/**
 * Provides the remote service interface for T_Ul_PAcademico. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see T_Ul_PAcademicoServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface T_Ul_PAcademicoService extends BaseService {
