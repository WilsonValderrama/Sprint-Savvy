...
/**
 * Provides the local service interface for T_Ul_Profesor. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see T_Ul_ProfesorLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface T_Ul_ProfesorLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.aula.sb.service.impl.T_Ul_ProfesorLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the t_ ul_ profesor local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link T_Ul_ProfesorLocalServiceUtil} if injection and service tracking are not available.
	 */
