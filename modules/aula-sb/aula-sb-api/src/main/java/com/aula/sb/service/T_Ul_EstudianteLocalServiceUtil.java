...
/**
 * Provides the local service utility for T_Ul_Estudiante. This utility wraps
 * <code>com.aula.sb.service.impl.T_Ul_EstudianteLocalServiceImpl</code> and
 ...
 * @generated
 */
public class T_Ul_EstudianteLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.aula.sb.service.impl.T_Ul_EstudianteLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static T_Ul_Estudiante addT_Ul_Estudiante(
		T_Ul_Estudiante t_Ul_Estudiante) {

		return getService().addT_Ul_Estudiante(t_Ul_Estudiante);
	}
	 ...
	 */
	public static T_Ul_Estudiante createT_Ul_Estudiante(long idEstudiante) {
		return getService().createT_Ul_Estudiante(idEstudiante);
	}
	 ...
	 */
	public static T_Ul_Estudiante deleteT_Ul_Estudiante(long idEstudiante)
		throws PortalException {

		return getService().deleteT_Ul_Estudiante(idEstudiante);
	}
	 ...
	 * @return the t_ ul_ estudiante that was removed
	 */
	public static T_Ul_Estudiante deleteT_Ul_Estudiante(
		T_Ul_Estudiante t_Ul_Estudiante) {

		return getService().deleteT_Ul_Estudiante(t_Ul_Estudiante);
	}
	...
	public static T_Ul_Estudiante fetchT_Ul_Estudiante(long idEstudiante) {
		return getService().fetchT_Ul_Estudiante(idEstudiante);
	}
	 ...
	 */
	public static T_Ul_Estudiante fetchT_Ul_EstudianteByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchT_Ul_EstudianteByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 * @throws PortalException if a t_ ul_ estudiante with the primary key could not be found
	 */
	public static T_Ul_Estudiante getT_Ul_Estudiante(long idEstudiante)
		throws PortalException {

		return getService().getT_Ul_Estudiante(idEstudiante);
	}
	 ...
	 */
	public static T_Ul_Estudiante getT_Ul_EstudianteByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getT_Ul_EstudianteByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<T_Ul_Estudiante> getT_Ul_Estudiantes(
		int start, int end) {

		return getService().getT_Ul_Estudiantes(start, end);
	}
	 ...
	 */
	public static List<T_Ul_Estudiante> getT_Ul_EstudiantesByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getT_Ul_EstudiantesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getT_Ul_EstudiantesCount() {
		return getService().getT_Ul_EstudiantesCount();
	}
	 ...
	 */
	public static T_Ul_Estudiante updateT_Ul_Estudiante(
		T_Ul_Estudiante t_Ul_Estudiante) {

		return getService().updateT_Ul_Estudiante(t_Ul_Estudiante);
	}

	public static T_Ul_EstudianteLocalService getService() {
		return _service;
	}

	private static volatile T_Ul_EstudianteLocalService _service;
