...
/**
 * Provides the local service utility for T_Ul_Calificacion. This utility wraps
 * <code>com.aula.sb.service.impl.T_Ul_CalificacionLocalServiceImpl</code> and
 ...
 * @generated
 */
public class T_Ul_CalificacionLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.aula.sb.service.impl.T_Ul_CalificacionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static T_Ul_Calificacion addT_Ul_Calificacion(
		T_Ul_Calificacion t_Ul_Calificacion) {

		return getService().addT_Ul_Calificacion(t_Ul_Calificacion);
	}
	 ...
	 * @return the t_ ul_ calificacion that was removed
	 */
	public static T_Ul_Calificacion deleteT_Ul_Calificacion(
		T_Ul_Calificacion t_Ul_Calificacion) {

		return getService().deleteT_Ul_Calificacion(t_Ul_Calificacion);
	}
	...
	public static T_Ul_Calificacion fetchT_Ul_Calificacion(
		long idCalificacion) {

		return getService().fetchT_Ul_Calificacion(idCalificacion);
	}
	 ...
	 */
	public static T_Ul_Calificacion fetchT_Ul_CalificacionByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchT_Ul_CalificacionByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static T_Ul_Calificacion getT_Ul_CalificacionByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getT_Ul_CalificacionByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<T_Ul_Calificacion> getT_Ul_Calificacions(
		int start, int end) {

		return getService().getT_Ul_Calificacions(start, end);
	}
	 ...
	 */
	public static List<T_Ul_Calificacion>
		getT_Ul_CalificacionsByUuidAndCompanyId(String uuid, long companyId) {

		return getService().getT_Ul_CalificacionsByUuidAndCompanyId(
			uuid, companyId);
	}
	...
	public static T_Ul_Calificacion updateT_Ul_Calificacion(
		...
		return getService().updateT_Ul_Calificacion(t_Ul_Calificacion);
	}

	public static T_Ul_CalificacionLocalService getService() {
		return _service;
	}

	private static volatile T_Ul_CalificacionLocalService _service;
