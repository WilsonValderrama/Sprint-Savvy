...
/**
 * The base model interface for the T_Ul_Profesor service. Represents a row in the &quot;AulaVirtual_T_Ul_Profesor&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.aula.sb.model.impl.T_Ul_ProfesorModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.aula.sb.model.impl.T_Ul_ProfesorImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface T_Ul_ProfesorModel
	extends BaseModel<T_Ul_Profesor>, GroupedModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a t_ ul_ profesor model instance should use the {@link T_Ul_Profesor} interface instead.
	 */
