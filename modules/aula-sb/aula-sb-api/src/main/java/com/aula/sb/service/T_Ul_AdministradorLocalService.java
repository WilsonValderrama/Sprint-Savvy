...
/**
 * Provides the local service interface for T_Ul_Administrador. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see T_Ul_AdministradorLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface T_Ul_AdministradorLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.aula.sb.service.impl.T_Ul_AdministradorLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the t_ ul_ administrador local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link T_Ul_AdministradorLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public T_Ul_Administrador addT_Ul_Administrador(
	...
	public T_Ul_Administrador createT_Ul_Administrador(long idAdmin);
	...
	public T_Ul_Administrador deleteT_Ul_Administrador(long idAdmin)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public T_Ul_Administrador deleteT_Ul_Administrador(
		T_Ul_Administrador t_Ul_Administrador);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public T_Ul_Administrador fetchT_Ul_Administrador(long idAdmin);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public T_Ul_Administrador fetchT_Ul_AdministradorByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public T_Ul_Administrador getT_Ul_Administrador(long idAdmin)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public T_Ul_Administrador getT_Ul_AdministradorByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<T_Ul_Administrador> getT_Ul_Administradors(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<T_Ul_Administrador> getT_Ul_AdministradorsByUuidAndCompanyId(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public T_Ul_Administrador updateT_Ul_Administrador(
		T_Ul_Administrador t_Ul_Administrador);
