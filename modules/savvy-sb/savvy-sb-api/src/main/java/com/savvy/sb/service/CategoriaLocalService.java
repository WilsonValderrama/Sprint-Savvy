...
/**
 * Provides the local service interface for Categoria. Methods of this
...
public interface CategoriaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.savvy.sb.service.impl.CategoriaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the categoria local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CategoriaLocalServiceUtil} if injection and service tracking are not available.
	 */
