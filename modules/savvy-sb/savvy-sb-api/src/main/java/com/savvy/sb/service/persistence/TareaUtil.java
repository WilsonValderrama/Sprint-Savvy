...
/**
 * The persistence utility for the tarea service. This utility wraps <code>com.savvy.sb.service.persistence.impl.TareaPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TareaUtil {
	 ...
	 */
	public static Map<Serializable, Tarea> fetchByPrimaryKeys(
	 ...
	 */
	public static List<Tarea> findWithDynamicQuery(
	 ...
	 */
	public static List<Tarea> findByUuid(
	 ...
	 */
	public static Tarea findByUuid_First(
			String uuid, OrderByComparator<Tarea> orderByComparator)
		throws com.savvy.sb.exception.NoSuchTareaException {
	 ...
	 */
	public static Tarea fetchByUuid_First(
		String uuid, OrderByComparator<Tarea> orderByComparator) {
	 ...
	 * @throws NoSuchTareaException if a matching tarea could not be found
	 */
	public static Tarea findByUuid_Last(
			String uuid, OrderByComparator<Tarea> orderByComparator)
		throws com.savvy.sb.exception.NoSuchTareaException {
	 ...
	 */
	public static Tarea fetchByUuid_Last(
		String uuid, OrderByComparator<Tarea> orderByComparator) {
	 ...
	 */
	public static Tarea[] findByUuid_PrevAndNext(
			long tareaId, String uuid,
			OrderByComparator<Tarea> orderByComparator)
		throws com.savvy.sb.exception.NoSuchTareaException {

		return getPersistence().findByUuid_PrevAndNext(
			tareaId, uuid, orderByComparator);
	}
	 ...
	 * @return the matching tarea, or <code>null</code> if a matching tarea could not be found
	 */
	public static Tarea fetchByUUID_G(
	 ...
	 * @return the range of matching tareas
	 */
	public static List<Tarea> findByUuid_C(
	 ...
	 * @throws NoSuchTareaException if a matching tarea could not be found
	 */
	public static Tarea findByUuid_C_First(
	 ...
	 * @return the first matching tarea, or <code>null</code> if a matching tarea could not be found
	 */
	public static Tarea fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<Tarea> orderByComparator) {
	 ...
	 * @throws NoSuchTareaException if a matching tarea could not be found
	 */
	public static Tarea findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<Tarea> orderByComparator)
		throws com.savvy.sb.exception.NoSuchTareaException {
	 ...
	 * @return the last matching tarea, or <code>null</code> if a matching tarea could not be found
	 */
	public static Tarea fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<Tarea> orderByComparator) {
	 ...
	 * @throws NoSuchTareaException if a tarea with the primary key could not be found
	 */
	public static Tarea[] findByUuid_C_PrevAndNext(
			long tareaId, String uuid, long companyId,
			OrderByComparator<Tarea> orderByComparator)
		throws com.savvy.sb.exception.NoSuchTareaException {

		return getPersistence().findByUuid_C_PrevAndNext(
			tareaId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @return the matching tareas
	 */
	public static List<Tarea> findByNombreTarea(String nombreTarea) {
		return getPersistence().findByNombreTarea(nombreTarea);
	}
	 ...
	 * @return the range of matching tareas
	 */
	public static List<Tarea> findByNombreTarea(
		String nombreTarea, int start, int end) {

		return getPersistence().findByNombreTarea(nombreTarea, start, end);
	}
	...
	public static List<Tarea> findByNombreTarea(
		...
		return getPersistence().findByNombreTarea(
	...
	public static List<Tarea> findByNombreTarea(
		...
		return getPersistence().findByNombreTarea(
			nombreTarea, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchTareaException if a matching tarea could not be found
	 */
	public static Tarea findByNombreTarea_First(
			String nombreTarea, OrderByComparator<Tarea> orderByComparator)
		throws com.savvy.sb.exception.NoSuchTareaException {

		return getPersistence().findByNombreTarea_First(
			nombreTarea, orderByComparator);
	}
	 ...
	 * @return the first matching tarea, or <code>null</code> if a matching tarea could not be found
	 */
	public static Tarea fetchByNombreTarea_First(
		String nombreTarea, OrderByComparator<Tarea> orderByComparator) {

		return getPersistence().fetchByNombreTarea_First(
			nombreTarea, orderByComparator);
	}
	 ...
	 * @throws NoSuchTareaException if a matching tarea could not be found
	 */
	public static Tarea findByNombreTarea_Last(
			String nombreTarea, OrderByComparator<Tarea> orderByComparator)
		throws com.savvy.sb.exception.NoSuchTareaException {

		return getPersistence().findByNombreTarea_Last(
			nombreTarea, orderByComparator);
	}
	 ...
	 * @return the last matching tarea, or <code>null</code> if a matching tarea could not be found
	 */
	public static Tarea fetchByNombreTarea_Last(
		String nombreTarea, OrderByComparator<Tarea> orderByComparator) {

		return getPersistence().fetchByNombreTarea_Last(
			nombreTarea, orderByComparator);
	}
	 ...
	 * @throws NoSuchTareaException if a tarea with the primary key could not be found
	 */
	public static Tarea[] findByNombreTarea_PrevAndNext(
			long tareaId, String nombreTarea,
			OrderByComparator<Tarea> orderByComparator)
		throws com.savvy.sb.exception.NoSuchTareaException {

		return getPersistence().findByNombreTarea_PrevAndNext(
			tareaId, nombreTarea, orderByComparator);
	}
	 ...
	 * @param nombreTarea the nombre tarea
	 */
	public static void removeByNombreTarea(String nombreTarea) {
		getPersistence().removeByNombreTarea(nombreTarea);
	}
	 ...
	 * @return the number of matching tareas
	 */
	public static int countByNombreTarea(String nombreTarea) {
		return getPersistence().countByNombreTarea(nombreTarea);
	}
	...
	private static volatile TareaPersistence _persistence;
