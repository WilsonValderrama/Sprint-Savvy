...
public interface TareaPersistence extends BasePersistence<Tarea> {
	 ...
	 */
	public java.util.List<Tarea> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Tarea>
			orderByComparator);
	 ...
	 * @return the range of matching tareas
	 */
	public java.util.List<Tarea> findByUuid_C(
	 ...
	 * @return the matching tareas
	 */
	public java.util.List<Tarea> findByNombreTarea(String nombreTarea);
	 ...
	 * @return the range of matching tareas
	 */
	public java.util.List<Tarea> findByNombreTarea(
