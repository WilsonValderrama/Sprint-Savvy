...
import com.savvy.sb.service.ProyectoLocalService;
...
/**
 * Provides the base implementation for the proyecto local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.savvy.sb.service.impl.ProyectoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.savvy.sb.service.impl.ProyectoLocalServiceImpl
 * @generated
 */
public abstract class ProyectoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ProyectoLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProyectoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProyectoLocalServiceUtil</code>.
	 */
	...
	public Proyecto createProyecto(long proyectoId) {
		return proyectoPersistence.create(proyectoId);
	}
	...
	public Proyecto deleteProyecto(Proyecto proyecto) {
		return proyectoPersistence.remove(proyecto);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Proyecto.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return proyectoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return proyectoPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return proyectoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return proyectoPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Proyecto fetchProyecto(long proyectoId) {
		return proyectoPersistence.fetchByPrimaryKey(proyectoId);
	}
	...
	public Proyecto fetchProyectoByUuidAndGroupId(String uuid, long groupId) {
		return proyectoPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(proyectoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Proyecto.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("proyectoId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Proyecto.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("proyectoId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Proyecto>() {

				@Override
				public void performAction(Proyecto proyecto)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, proyecto);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return proyectoPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return proyectoLocalService.deleteProyecto((Proyecto)persistedModel);
	}

	public BasePersistence<Proyecto> getBasePersistence() {
		return proyectoPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return proyectoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Proyecto> getProyectosByUuidAndCompanyId(
		...
		return proyectoPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Proyecto> getProyectosByUuidAndCompanyId(
		...
		return proyectoPersistence.findByUuid_C(
	...
	public Proyecto getProyectoByUuidAndGroupId(String uuid, long groupId)
		...
		return proyectoPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Proyecto> getProyectos(int start, int end) {
		return proyectoPersistence.findAll(start, end);
	}
	...
	public int getProyectosCount() {
		return proyectoPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProyectoLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		proyectoLocalService = (ProyectoLocalService)aopProxy;

		_setLocalServiceUtilService(proyectoLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProyectoLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ProyectoLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, proyectoLocalService);
		}
	...
	protected ProyectoLocalService proyectoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProyectoLocalServiceBaseImpl.class);
